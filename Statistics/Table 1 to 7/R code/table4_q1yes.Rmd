...
```{r}
LS_read_ratings <- read_excel("Likert_Repro.xlsx", sheet = "read_q1yes")
LS_coh_ratings <- read_excel("Likert_Repro.xlsx", sheet = "cohe_q1yes")
```
...
```{r}
RME_read_ratings <- read_excel("RME.xlsx", sheet = "read_q1yes")
RME_coh_ratings <- read_excel("RME.xlsx", sheet = "cohe_q1yes")
...
```{r}
BME_read_ratings <- read_excel("BME.xlsx", sheet = "read_q1yes")
BME_coh_ratings <- read_excel("BME.xlsx", sheet = "cohe_q1yes")
...
```{r}
RR_read_ratings <- read_excel("RR.xlsx", sheet = "read_q1yes")
RR_coh_ratings <- read_excel("RR.xlsx", sheet = "cohe_q1yes")
