...
```{r}
LS_read_ratings <- read_excel("Likert_Repro.xlsx", sheet = "read_q2no")
LS_coh_ratings <- read_excel("Likert_Repro.xlsx", sheet = "cohe_q2no")
```
...
```{r}
RME_read_ratings <- read_excel("RME.xlsx", sheet = "read_q2no")
RME_coh_ratings <- read_excel("RME.xlsx", sheet = "cohe_q2no")
...
```{r}
BME_read_ratings <- read_excel("BME.xlsx", sheet = "read_q2no")
BME_coh_ratings <- read_excel("BME.xlsx", sheet = "cohe_q2no")
...
```{r}
RR_read_ratings <- read_excel("RR.xlsx", sheet = "read_q2no")
RR_coh_ratings <- read_excel("RR.xlsx", sheet = "cohe_q2no")
