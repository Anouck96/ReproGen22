...
```{r}
LS_read_ratings <- read_excel("Likert_Repro.xlsx", sheet = "read_rank_below")
LS_coh_ratings <- read_excel("Likert_Repro.xlsx", sheet = "cohe_rank_below")
```
...
```{r}
RME_read_ratings <- read_excel("RME.xlsx", sheet = "read_rank_below")
RME_coh_ratings <- read_excel("RME.xlsx", sheet = "cohe_rank_below")
...
```{r}
BME_read_ratings <- read_excel("BME.xlsx", sheet = "read_rank_below")
BME_coh_ratings <- read_excel("BME.xlsx", sheet = "cohe_rank_below")
...
```{r}
RR_read_ratings <- read_excel("RR.xlsx", sheet = "read_rank_below")
RR_coh_ratings <- read_excel("RR.xlsx", sheet = "cohe_rank_below")
