...
```{r}
LS_read_ratings <- read_excel("Likert_Repro.xlsx", sheet = "read_q1no")
LS_coh_ratings <- read_excel("Likert_Repro.xlsx", sheet = "cohe_q1no")
```
...
```{r}
RME_read_ratings <- read_excel("RME.xlsx", sheet = "read_q1no")
RME_coh_ratings <- read_excel("RME.xlsx", sheet = "cohe_q1no")
...
```{r}
BME_read_ratings <- read_excel("BME.xlsx", sheet = "read_q1no")
BME_coh_ratings <- read_excel("BME.xlsx", sheet = "cohe_q1no")
...
```{r}
RR_read_ratings <- read_excel("RR.xlsx", sheet = "read_q1no")
RR_coh_ratings <- read_excel("RR.xlsx", sheet = "cohe_q1no")
