...
```{r}
LS_read_ratings <- read_excel("Likert_Repro.xlsx", sheet = "read_q2yes")
LS_coh_ratings <- read_excel("Likert_Repro.xlsx", sheet = "cohe_q2yes")
```
...
```{r}
RME_read_ratings <- read_excel("RME.xlsx", sheet = "read_q2yes")
RME_coh_ratings <- read_excel("RME.xlsx", sheet = "cohe_q2yes")
...
```{r}
BME_read_ratings <- read_excel("BME.xlsx", sheet = "read_q2yes")
BME_coh_ratings <- read_excel("BME.xlsx", sheet = "cohe_q2yes")
...
```{r}
RR_read_ratings <- read_excel("RR.xlsx", sheet = "read_q2yes")
RR_coh_ratings <- read_excel("RR.xlsx", sheet = "cohe_q2yes")
