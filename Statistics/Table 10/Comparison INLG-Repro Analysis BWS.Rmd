...
```{r}
read_ratings_INLG <- read_excel("RR_INLG.xlsx", sheet = "read_rank_all")
read_ratings_Repro <- read_excel("RR_REPRO.xlsx", sheet = "read_rank_all")
cohe_ratings_INLG <- read_excel("RR_INLG.xlsx", sheet = "cohe_rank_all")
cohe_ratings_Repro <- read_excel("RR_REPRO.xlsx", sheet = "cohe_rank_all")
```

#Correlation BWS Readability on Mean score and Mode score per sentence
```{r}
...
res2
```
#Correlation BWS Coherence on Mean score and Mode score per sentence
```{r}
