...
```{r}
read_ratings_INLG <- read_excel("Likert_INLG.xlsx", sheet = "read_rank_all")
read_ratings_Repro <- read_excel("Likert_REPRO.xlsx", sheet = "read_rank_all")
cohe_ratings_INLG <- read_excel("Likert_INLG.xlsx", sheet = "cohe_rank_all")
cohe_ratings_Repro <- read_excel("Likert_REPRO.xlsx", sheet = "cohe_rank_all")
```

#Correlation Likert Readability on Mean score and Mode score per sentence
```{r}
...
res2
```
#Correlation Likert Coherence on Mean score and Mode score per sentence
```{r}
