...
library(readxl)
knitr::opts_knit$set(root.dir = '"C:/Usersfjytomas/OneDrive - Tilburg University/Documents/INLG-Eval-Public Data-20220503T073540Z-001/ReProGen/Table 8/SpearmanMode')
```

```{r}
getwd()
read_ratings <- read_excel("correlation_ranks_LS.xlsx", sheet = "read_rank_all")
cohe_ratings <- read_excel("correlation_ranks_LS.xlsx", sheet = "cohe_rank_all")
```
